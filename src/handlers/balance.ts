import { forceToCurrencyId, forceToCurrencyIdName, isDexShare, mockEventRecord } from '@setheum.js/sdk-core';
...
// 	record.total = Number(record.balance || 0) + Number(record.collateral || 0) + ''
